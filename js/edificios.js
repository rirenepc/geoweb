   function addEdificiosCapa() {
    ...
    map.addSource("edificios_source", {
        "type": "vector",
        "url": "mapbox://rirenepc.52usynvj"  // Nuestor ID Tileset
    ...
    "source-layer": "construcciones-7b4c3r", // Nuestro nombre Tileset
    "maxzoom": 21,
    "minzoom": 14,
   "filter": [">", "numberOfFl", 0],
    "paint": {
        ...
        "fill-extrusion-height": [
            ...
            16, ["*", 2.5, ["to-number", ["get", "numberOfFl"]]],
            20, ["*", 4, ["to-number", ["get", "numberOfFl"]]]
        ],
